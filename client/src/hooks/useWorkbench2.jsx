...
// // Initialize Yjs document and provider outside the hook (if needed per session you could also put inside)
...
//   // Workbench items and layout state (sections hold both sections and items inside them)
...
//   // ---------------------------
//   // Cell Dimensions and Layout Helpers
//   // ---------------------------
//   const cellWidth = 100;
//   const cellHeight = 50;
...
//     try {
//       const response = await fetch(`${SERVER_URL}/api/layouts`, { headers: { 'Authorization': `Bearer ${token}` } });
//       console.log("Response fetching layouts:", response);
//       if (response.ok) {
//         const data = await response.json();
...
//     try {
//       const response = await fetch(`${SERVER_URL}/api/layouts?userId=${userId}`, { headers: { 'Authorization': `Bearer ${token}` } });
//       if (response.ok) {
//         const data = await response.json();
//         setAvailableLayouts(data.layouts);
//       } else {
...
//     console.log("Sections loaded from layout:", layout.sections);
//     setLayoutTitle(layout.title);
//     setShowLayoutList(false);
//     setShowSetupForm(false);
//     // Sync loaded layout to Yjs
//     syncYjsSections();
//     console.log("Layout loaded and Yjs synced:", layout);
//   };
...
//           })
//         );
//         console.log("Image item added to section:", imageItem);
...
//       })
//     );
//     console.log("New item added to section:", newItem);
//     setSelectedId(newItem.id);
//     syncYjsSections();
//   };

//   // Add a new section (for manual section addition)
...
//     console.log("New section added locally:", newSection);
...
//   // ---------------------------
//   // Overlap and Positioning Helpers
//   // ---------------------------
...
//         if (itemsOverlap({ ...item, gridX: originalPosition.gridX, gridY: originalPosition.gridY }, other)) {
//           conflict = true;
//           break;
//         }
//       }
...
//     }
//     const possiblePositions = [];
//     console.log("Item size for positioning:", item.sizeInfo);
//     for (let y = 0; y <= rows - item.sizeInfo.rows; y++) {
//       for (let x = 0; x <= columns - item.sizeInfo.cols; x++) {
//         let conflict = false;
//         for (let other of fixedItems) {
//           if (itemsOverlap({ ...item, gridX: x, gridY: y }, other)) {
//             conflict = true;
//             break;
//           }
//         }
...
//   // ---------------------------
//   // Selection and Transformer Handling
//   // ---------------------------
...
//   // Stage and transformer refs
//   const stageRef = useRef(null);
//   const transformerRef = useRef(null);

//   // ---------------------------
//   // Handlers for Transform (Scaling/Dragging)
//   // ---------------------------
...
//       )
//     );
//     console.log("Local transform update applied for item:", selectedId);
//     // Sync changes to Yjs
//     syncYjsSections();
//     node.scaleX(1);
//     node.scaleY(1);
...
//       const newOverlappingItems = remainingItems.filter(b => b.id !== item.id && itemsOverlap(itemWithNewPos, b));
...
//     if (!e || !e.target) {
//       alert("Error: Dragging operation failed.");
//       return;
//     }
...
//   // ---------------------------
//   // Additional Item Addition for Predefined Sizes
//   // ---------------------------
//   const addPredefineditem = (size, type) => {
//     let newItem;
//     if (type === "box") newItem = addBox(size);
//     else if (type === "text") newItem = addTextBox(size);
//     else newItem = addImageItem(size);
//     const position = findBestPositionForBox(newItem, sections, columns, rows);
//     if (!position) {
//       alert('No space available for new item');
//       return;
//     }
//     console.log("Predefined item position:", position);
...
//   // ---------------------------
//   // Text Change and Formatting Handlers
//   // ---------------------------
...
//           return { ...section, items: section.items.filter(item => item.id !== selectedId) };
//         })
//         .filter(Boolean)
//     );
//     setSelectedId(null);
...
//   // ---------------------------
//   // File Conversion and Upload Handlers
//   // ---------------------------
...
//     const stage = stageRef.current;
//     console.log("Uploading canvas image, stage ref:", stage);
//     if (stage) {
...
//     const stage = stageRef.current;
//     console.log("Exporting canvas to PDF, stage ref:", stage);
...
//   // ---------------------------
//   // Return all state and functions to the context
//   // ---------------------------
//   return {
//     userId,
//     showSetupForm,
